...
│   └── meta/
│       ├── decay-scores.json    # Relevance + consolidation tracking
│       ├── reflection-log.md    # Summaries (loaded into context)
│       ├── reflections/         # Full archive (permanent, searchable)
│       │   ├── 2026-02-04.md    # One file per reflection
│       │   └── ...
│       ├── pending-reflection.md # Current reflection proposal
│       ├── pending-memories.md  # Sub-agent proposals
│       ├── evolution.md         # Cognitive evolution tracker
...
2. Append SUMMARY → `reflection-log.md` (loaded into context)
3. Extract `[Self-Awareness]` → IDENTITY.md Self-Awareness Log
4. If 10+ new entries → trigger Self-Image Consolidation
5. Update timestamps
