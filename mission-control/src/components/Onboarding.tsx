...
const DEFAULT_AGENTS: AgentFormData[] = [
  { name: "Arthur", role: "Orchestrator", emoji: "🎩", color: "#10b981" },
  { name: "Marcus", role: "CRM (GoHighLevel)", emoji: "📞", color: "#3b82f6" },
  { name: "Sage", role: "Projects (Asana)", emoji: "📋", color: "#8b5cf6" },
  { name: "Quant", role: "Trading & Finance", emoji: "📈", color: "#f59e0b" },
  { name: "Echo", role: "Communications", emoji: "🔊", color: "#ec4899" },
];
...
export function Onboarding() {
  ...
  const handleDeploy = async () => {
    ...
    console.log("Deploy (mock):", agents);
    setDeploying(false);
  };
      ...
      <div className="w-full max-w-4xl">
        <div className="text-center mb-8">
          ...
          <p className="text-[#737373] font-mono text-sm">
            Customize your agents before deployment
          </p>
        </div>

        <div className="space-y-4 mb-8">
          {agents.map((agent, index) => (
            <div key={index} className="bg-[#0c0c0c] border border-[#1e1e1e] rounded-lg p-6">
