...
import { useMockLeads } from "@/hooks/useMockData";
            ...
            {leads.map(lead => (
              <tr key={lead._id} className="border-b border-[#1e1e1e] hover:bg-[#1e1e1e] transition-colors">
                ...
                <td className="px-4 py-3">
                  <span className="bg-[#1e1e1e] border border-[#2e2e2e] rounded px-2 py-1 text-xs text-emerald-500 font-mono uppercase">
                    {lead.status}
                  </span>
                </td>
