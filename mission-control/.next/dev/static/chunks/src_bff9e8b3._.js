...
function MetricsBar({ tasks }) {
    _s();
    const { data: airtableData } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$useAirtableData$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAirtableData"])();
    const [ghlData, setGHLData] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])({
        smsToday: 0
    });
    ...
    // Fetch GHL SMS data
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "MetricsBar.useEffect": ()=>{
            fetch('/api/ghl').then({
                "MetricsBar.useEffect": (res)=>res.json()
            }["MetricsBar.useEffect"]).then({
                "MetricsBar.useEffect": (data)=>setGHLData(data)
            }["MetricsBar.useEffect"]).catch({
                "MetricsBar.useEffect": (err)=>console.error('Failed to fetch GHL data:', err)
            }["MetricsBar.useEffect"]);
        }
    }["MetricsBar.useEffect"], []);
    // Fetch email data
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "MetricsBar.useEffect": ()=>{
            fetch('/api/email').then({
                "MetricsBar.useEffect": (res)=>res.json()
            }["MetricsBar.useEffect"]).then({
                "MetricsBar.useEffect": (data)=>setEmailData(data)
            }["MetricsBar.useEffect"]).catch({
                "MetricsBar.useEffect": (err)=>console.error('Failed to fetch email data:', err)
            }["MetricsBar.useEffect"]);
        }
    }["MetricsBar.useEffect"], []);
    const metrics = [
...
_s(MetricsBar, "Yepkj+ts7CNbkM7ibyNBlp76eoE=", false, function() {
    return [
...
"[project]/src/components/DealPipeline.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function DealPipeline() {
    _s();
    const deals = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$useMockData$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMockDeals"])();
...
_s(DealPipeline, "2Q28of52N/AaG4pHlVTYJGmdYbI=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$useMockData$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMockDeals"]
    ];
});
_c = DealPipeline;
var _c;
__turbopack_context__.k.register(_c, "DealPipeline");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$DealPipeline$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/components/DealPipeline.tsx [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/next/dist/compiled/react/index.js [app-client] (ecmascript)");
;
var _s = __turbopack_context__.k.signature();
"use client";
                ...
                return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    ...
                    children: [
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            ...
                            children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$DealPipeline$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["DealPipeline"], {}, void 0, false, {
                                fileName: "[project]/src/app/page.tsx",
                                lineNumber: 96,
                                columnNumber: 15
                            }, this)
...
_s(Dashboard, "UYEofi2NE6iVUF3mfHD1zmHezps=", false, function() {
    return [
...
//# sourceMappingURL=src_bff9e8b3._.js.map